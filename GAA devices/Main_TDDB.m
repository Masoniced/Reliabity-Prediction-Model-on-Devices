...
load('C:\Users\Mason\Documents\Project\Matlab Project\MMC-GAA\Byproducts\200_78_10_GAA_PIT2.mat')
...
Initial_Ipre_mean=(VI^(x_r(1))*exp(x_r(2)))*2.4675e4; % (t_o/(n_w*n_l*n_f))=2.4675e4
...
while number<=10
    ...
    temp_current=Result_list(:,3)/Result_list(3,3)*Initial_Ipre*(n_w*n_l*n_f)/t_o*(Result_list(2,1))^(slope)*(exp(x(1)*log((VI*4e-9/((n3-2)*aphla_C)))+x(2)));
