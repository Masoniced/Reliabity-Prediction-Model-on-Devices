function [p,data,final,curve]=Cluster_fitting_bicluster(Data,ratio,fixa,fixb,fixtor)
...
if isempty(fixa)&&isempty(fixb)&&isempty(fixtor)
    for i=1:length(data)
        ...
        t_G3=G3(a1,a2,b1,b2,data(i),tor1,tor2)+t_G3;
        t_G4=G4(a1,a2,b1,b2,data(i),tor1,tor2)+t_G4;
        t_G5=G5(a1,a2,b1,b2,data(i),tor1,tor2)+t_G5;
        t_G6=G6(a1,a2,b1,b2,data(i),tor1,tor2)+t_G6;        
        F=Lf(a1,a2,b1,b2,data(i),tor1,tor2)+F;
    end
    ...
    error=1;
    c=1;
    F1=F(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6));
    count=0;
    list=[];
    while error>criteria
        count=count+1;
        list(count,1:6)=temp_x;
        list(count,7)=F1;
        if c==1
            grad=[t_G1(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)),t_G2(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)),t_G3(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)),t_G4(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)),t_G5(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)),t_G6(temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6))];
            p=grad./sqrt(grad(1)^2+grad(2)^2+grad(3)^2+grad(4)^2+grad(5)^2+grad(6)^2);
        end
        ...
        elseif next_x(3)<0
            ...
            F2=F(next_x(1),next_x(2),next_x(3),next_x(4),next_x(5),next_x(6));
        end
        if F2<F1
            temp_x=next_x;
            error=abs((F2-F1)/F1);
...
%             alph=5;
    ...
    final=[temp_x(1),temp_x(2),temp_x(3),temp_x(4),temp_x(5),temp_x(6)];
    ...
    for i=j
        pre_test=CDF(final(1),final(2),final(3),final(4),i,final(5),final(6));
