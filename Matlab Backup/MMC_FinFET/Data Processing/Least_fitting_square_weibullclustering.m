function [u,data,final,curve]=Least_fitting_square_weibullclustering(Data,ratio,fixa,fixb)
syms b1 tor1 a2 b2 tor2 x
CDF=1-exp(-(x/tor1)^(b1))*((1+1/a2*(x/tor2)^b2)^(-a2));
...
if isempty(fixa)&&isempty(fixb)
    input_vec=[a2,b1,b2,tor1,tor2];
    n_input=[a2,b1,b2,tor1,tor2];
